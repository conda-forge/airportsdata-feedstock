...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/airportsdata-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/airportsdata-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add airportsdata
# for installing globally
pixi global install airportsdata
```
...
It is possible to list all of the versions of `airportsdata` available on your platform:
...
```
pixi search airportsdata --channel conda-forge
```
